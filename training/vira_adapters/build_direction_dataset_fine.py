"""Build the 27-label direction dataset for the ViRA fine adapter.

The full label set including the stop class, with augmented copies resolved
back to their source label through the rename mapping. Dead-band 0.5 mm and
0.2 deg.

Feeds the adapter served by vira_coarse_to_fine/servers/serve_direction_fine.py.
"""
...
# Define paths
base_path = os.path.join(BASE_DIR, "opentron_wrong51")
...
output_json = os.path.join(base_path, "augmented_camera1_crop2.json")
