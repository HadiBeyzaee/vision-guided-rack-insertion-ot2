"""Flatten the LLaVA conversation JSON to {image, label} pairs for the CNN.

Step 5 of the dataset pipeline. Both models therefore train on exactly the same
images and the same labels, which is what makes the CNN-versus-VLM
