...
image_dirs = [
    ...
    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base1/color_images/camera1_cropped1'),
    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base2/color_images/camera1_cropped1'),
    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base3/color_images/camera1_cropped1'),
    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base4/color_images/camera1_cropped1'),
    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base5/color_images/camera1_cropped1'),

    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base1/color_images/camera1_align_cropped1_name'),
    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base2/color_images/camera1_align_cropped1_name'),
    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base3/color_images/camera1_align_cropped1_name'),
    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base4/color_images/camera1_align_cropped1_name'),
    os.path.join(BASE_DIR, 'opentron_wrong_grasp_base5/color_images/camera1_align_cropped1_name'),
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict, 'train_regression_crop1_crop2.pth')

    scheduler.step


# Load the best model for testing
model.load_state_dict(torch.load('train_regression_crop1_crop2.pth'))
model.eval
