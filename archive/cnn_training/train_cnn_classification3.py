...
# Define Paths
json_file_path = os.path.join(BASE_DIR, "cnn_augmented_camera1_crop3_slot123_dxyt.json")
...
def train_model(model, train_loader, val_loader, num_epochs=20, lr=0.0001, device="cuda"):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict, "cnn_camera1_crop3_slot5_dxyt123_vgg.pth")
...
model.load_state_dict(torch.load("cnn_camera1_crop3_slot5_dxyt123_vgg.pth"))
