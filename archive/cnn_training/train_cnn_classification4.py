...
class ClassificationModel(nn.Module):
    def __init__(self, model_type='resnet', pretrained=True, freeze_backbone=True):
        ...
        # this is your "adapter" like in VLM
...
def train_model(model, train_loader, val_loader, num_epochs=12, lr=0.0001, device="cuda"):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict, "cnn_augmented2_camera2_crop1_vgg_vlm_twin2.pth")
...
model.load_state_dict(torch.load("cnn_augmented2_camera2_crop1_vgg_vlm_twin2.pth"))
