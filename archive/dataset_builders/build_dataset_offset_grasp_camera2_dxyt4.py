"""Archived variant. Originally named `llava_wrong4.py`.
...
# Define paths
txt_file_path =     os.path.join(BASE_DIR, "camera2_dxyt4/error_data_new.txt")
fail_image_folder = os.path.join(BASE_DIR, "camera2_dxyt4/color_images/camera2_renamed_cropped2")
fail_mapping_file = os.path.join(BASE_DIR, "camera2_dxyt4/color_images/image_row_mapping_camera2_renamed.json")
output_json =       os.path.join(BASE_DIR, "camera2_dxyt4/camera2_crop2.json")

# # # Define paths
# txt_file_path =     os.path.join(BASE_DIR, "camera2_dxyt4/error_data_align.txt")
# fail_image_folder = os.path.join(BASE_DIR, "camera2_dxyt4/color_images/camera2_align_renamed_cropped1")
# fail_mapping_file = os.path.join(BASE_DIR, "camera2_dxyt4/color_images/image_row_mapping_camera2_align_new_renamed.json")
# output_json =       os.path.join(BASE_DIR, "camera2_dxyt4/camera2_crop1_align.json")
