...
position = [0.63+0.08, 0.129, 0.253]
...
for i in range(300):
    ...
    dx = 0*random.uniform(-0.012, 0.012)  # -0.05 to 0.05 meters
    dy = 0*random.uniform(-0.012, 0.012)  # -0.05 to 0.05 meters
    #dz = random.uniform(-0.01, 0.01)
    dtheta = 0*random.uniform(-3.0, 3.0)    # -5 to 5 degrees
