...
dxx = random.uniform(-0.012, 0.012)
dyy = random.uniform(-0.012, 0.012)
dtheta = random.uniform(-3.0, 3.0)
print('dx: ', dx)
print('dxx: ', dxx)
print('dyy: ', dyy)
print('dtheta: ', dtheta)
...
#position = [0.591 + dxx , 0.262 + dyy , 0.25]
