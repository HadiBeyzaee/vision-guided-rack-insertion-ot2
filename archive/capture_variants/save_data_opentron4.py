...
position = [0.63+0.09, 0.262, 0.253]
...
for i in range(300):
    ...
    dx = random.uniform(-0.0005, 0.0005)  # -0.05 to 0.05 meters
    dy = random.uniform(-0.0005, 0.0005)  # -0.05 to 0.05 meters
