...
#0.7175
position = [0.63+0.086, -0.006, 0.253]
...
for i in range(300):
    ...
    dx = random.uniform(-0.01, 0.01)  # -0.05 to 0.05 meters
    dy = random.uniform(-0.01, 0.01)  # -0.05 to 0.05 meters
