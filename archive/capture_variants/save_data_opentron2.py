...
for i in range(100):
    ...
    dx = 0*random.uniform(-0.01, 0.01)  # -0.05 to 0.05 meters
    dy = 0*random.uniform(-0.01, 0.01)  # -0.05 to 0.05 meters
    #dz = random.uniform(-0.01, 0.01)
    dtheta = 0*random.uniform(-2, 2.1)    # -5 to 5 degrees
