...
#position = [0.63, -0.003, 0.255]
#position = [0.63, 0.265, 0.255]
position = [0.63+0.092,0.265, 0.254]
...
for i in range(100):
    ...
    dx = random.uniform(-0.015, 0.015)  # -0.05 to 0.05 meters
    dy = random.uniform(-0.015, 0.015)  # -0.05 to 0.05 meters
    #dz = random.uniform(-0.01, 0.01)
    dtheta = random.uniform(-2.5, 2.5)    # -5 to 5 degrees
