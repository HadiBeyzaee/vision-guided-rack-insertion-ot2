...
TRAIN_DATA_PATH = os.path.join(BASE_DIR, "camera1_crop2_multi_8class_merged.json")
...
deepspeed {LLAVA_REPO}/llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-opentron-camera1-crop2-multi-8class-lora \
    --num_train_epochs 8 \
