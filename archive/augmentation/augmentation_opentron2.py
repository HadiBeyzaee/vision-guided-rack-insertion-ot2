...
# Define Paths
input_folder =  os.path.join(BASE_DIR, "opentron_station31/color_images/camera1_renamed_cropped2")
output_folder = os.path.join(BASE_DIR, "opentron_station31/color_images/camera1_renamed_cropped2_augmented")
...
num_augmentations = 1  # Change this to increase or decrease the number of augmented versions
