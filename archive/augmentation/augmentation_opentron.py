...
# Define Paths
input_folder =  os.path.join(BASE_DIR, "external_wrong3/color_images/camera1_renamed_cropped1")
output_folder = os.path.join(BASE_DIR, "external_wrong3/color_images/camera1_renamed_cropped1_augmented")
