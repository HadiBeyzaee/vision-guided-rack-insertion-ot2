...
test_folder = os.path.join(BASE_DIR, "opentron_wrong_test/opentron_wrong_test2/color_images/camera1_cropped2")
...
model.load_state_dict(torch.load(os.path.join(BASE_DIR, "cnn_camera1_crop2_aug_wrong_station123.pth"), map_location=device))
model.to(device)
