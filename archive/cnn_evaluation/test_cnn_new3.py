...
test_folder =     os.path.join(BASE_DIR, "external_wrong2/color_images/camera1_cropped1")
error_data_file = os.path.join(BASE_DIR, "external_wrong2/error_data.txt")
...
def classify_combined(dx):
    move_x = classify_movement(dx)
...
with open(error_data_file, "r") as f:
    for idx, line in enumerate(f.readlines):
        ...
        dx = values[0]  # Get just the dx value
        label = classify_combined(dx)
