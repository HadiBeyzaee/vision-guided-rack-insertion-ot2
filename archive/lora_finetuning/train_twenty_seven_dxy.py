...
TRAIN_DATA_PATH = os.path.join(BASE_DIR, "camera1_crop2_aug_wrong.json")


IMAGE_FOLDERS = ",".join([

    os.path.join(BASE_DIR, "opentron_wrong51/color_images/camera1_renamed_cropped2_augmented"),
    os.path.join(BASE_DIR, "opentron_wrong52/color_images/camera1_renamed_cropped2_augmented"),
...
deepspeed {LLAVA_REPO}/llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-opentron-wrong-crop2-camera1-lora \
    --num_train_epochs 20 \
