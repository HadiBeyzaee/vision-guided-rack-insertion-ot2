...
TRAIN_DATA_PATH = os.path.join(BASE_DIR, "camera1_crop2_coarse_fine_updated_merged.json")
...
IMAGE_FOLDERS = ",".join([
    ...
    os.path.join(BASE_DIR, "opentron_station33/color_images/camera1_renamed_cropped2"),
    ...
    os.path.join(BASE_DIR, "opentron_station17/color_images/camera1_renamed_cropped2"),
])
...
deepspeed {LLAVA_REPO}/llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-opentron-camera1-crop2-coarse-fine-updated-lora \
    --num_train_epochs 10 \
