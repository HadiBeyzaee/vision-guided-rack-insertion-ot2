...
# Model configuration
model_path = os.path.join(CHECKPOINT_DIR, "llava-v1.5-7b-opentron-camere1-crop1-station5-123456-SHORT-PROMPT-HIGH-ALPHA-lora")
...
# Inference query
query_combined = (
    "What movement and what rotation are needed to align the object with the slot?")
