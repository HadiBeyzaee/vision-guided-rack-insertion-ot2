...
# Model configuration
model_path = os.path.join(CHECKPOINT_DIR, "llava-v1.5-7b-opentron-camera1-crop1-high-angle-aug-lora")
...
# Inference query
query_combined = (
    "This cropped image shows the object position and orientation relative to the slot. what movement and what rotation are needed to align it properly?"
)
# Flask app setup
app = Flask(__name__)
