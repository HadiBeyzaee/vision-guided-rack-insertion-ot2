...
def pick_Rack(rack_color="white"):
    ...
    panda.move_to_joint_position([1.6245797046670103, -0.11402809741964566, -0.08876788540685361, -1.4589830255597422, -0.07862584180588267, 1.432335729651981, 0.7393831875382199], speed_factor=0.06)

    panda.move_to_joint_position([1.405592972866556, 0.035182558052371894, 0.030527212032514416, -1.8813557672333296, -0.002476126438648679, 1.9326529455714756, 0.6681306372541519], speed_factor=0.06)
    ...
    if rack_color in ['blue', 'black']:
        panda.move_to_joint_position([1.0400525315351652, 0.30537512338418743, 0.6040118927311647, -1.686294190741374, -0.18297076455455014, 1.9470353934388271, 0.9026697534755894], speed_factor=0.06)
        position = [0.0, 0.628, 0.139]
    elif rack_color in ['transparent', 'white']:
        panda.move_to_joint_position([1.0325034557810564, 0.44021967446595084, 0.2586991294894302, -1.4646487560067245, -0.10496250588374732, 1.937397437284309, 0.5141607142578062], speed_factor=0.06)
        position = [0.225, 0.648, 0.139]
