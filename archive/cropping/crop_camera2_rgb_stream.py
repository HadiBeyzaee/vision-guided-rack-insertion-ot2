"""Archived variant. Originally named `save_cut_wrong3.py`.
...
# image_dir =  os.path.join(BASE_DIR, "camera2_dxyt4/color_images/camera2_align_new_renamed")
# output_dir = os.path.join(BASE_DIR, "camera2_dxyt4/color_images/camera2_align_renamed_cropped1")
...
image_dir =  os.path.join(BASE_DIR, "rack_slot_rgb_stream/rgb")
output_dir = os.path.join(BASE_DIR, "rack_slot_rgb_stream/rgb_cropped")
